...
- ✅ Difference between traditional data centers and cloud computing
- ✅ AWS regions, availability zones, and edge locations
- ✅ Exam blueprint and certification roadmap
...
#### Key Learning Outcomes:
- ✅ IAM best practices and security fundamentals
...
- ✅ Setting up billing alerts and cost management
...
- ✅ Implement VPC peering across accounts and regions
- ✅ Understand Transit Gateway architecture
- ✅ Configure VPN and Direct Connect
...
#### Key Learning Outcomes:
- ✅ Understanding S3 storage classes and use cases
- ✅ Implementing S3 lifecycle policies
- ✅ Configuring cross-region replication
- ✅ S3 security and encryption methods
- ✅ Static website hosting on S3
- ✅ EBS volumes and snapshot management
...
- ✅ EC2 troubleshooting techniques
...
#### 💻 Project 7:
**Build a 2-Tier Web Application with EC2 and DynamoDB**

#### Key Learning Outcomes:
- ✅ Understand SQL vs NoSQL databases
- ✅ Deploy and configure RDS instances
- ✅ Implement RDS backup and restore
...
- ✅ Configure Lambda triggers and events
...
- ✅ Optimize serverless applications
...
- ✅ Implement decoupled applications
...
- ✅ Use translation and transcription services
...
- ✅ Migrate databases with DMS
- ✅ Track migrations with Migration Hub
- ✅ Implement migration best practices
- ✅ Handle various migration scenarios
...
#### 💻 Project 14:
**Design a Solutioning document with Architectural Diagrams and Details to help customer for Cloud Migration**
...
<details>
<summary><h3>Module 15: Capstone Project</h3></summary>

**Overview:** Prepare a code pipeline and deploy to a cluster-based environment in blue/green deployment model and apply the skills and knowledge which were developed during the cohort.

#### Project Requirements:
Create a server less architecture and do event logging application using elastic search & kibana.
...
### Course Materials:
- ✅ 66 hours of comprehensive instruction
...
```
Module 1-2: Foundations (Cloud Computing, IAM)
    ↓
Module 3-4: Core Infrastructure (Networking, Storage)
    ↓
Module 5-6: Compute & High Availability (EC2, Load Balancing)
    ↓
Module 7-8: Databases & Serverless
    ↓
Module 9-10: Application Services & Analytics
    ↓
Module 11-12: AI/ML & Migration
    ↓
Module 13-14: Architecture & Best Practices
    ↓
...
By the end of this course, you will have completed 15 real-world projects:

1. ✅ IAM Cross-Account Access
2. ✅ VPC with Transit Gateway
3. ✅ Static Website on S3
4. ✅ 2-Tier Web Application
5. ✅ Auto Scaling with Load Balancer
6. ✅ 3-Tier Fault-Tolerant Application
7. ✅ EC2 with DynamoDB Application
8. ✅ Serverless Web Application
9. ✅ Kinesis Streaming Solution
10. ✅ Big Data Pipeline
11. ✅ Serverless Contact Centre
12. ✅ On-Premises to Cloud Migration
13. ✅ Solution Design Presentation
14. ✅ Architecture Document
15. ✅ Capstone: Blue/Green Serverless App

---

## 📞 Contact & Support

**Program:** AWS Job Ready Program  
**Provider:** Pragra  
...
This course material is provided by Pragra for educational purposes.

---

## 🌟 Next Steps

1. Complete all 15 modules
2. Finish all hands-on projects
3. Practice with scenario-based questions
4. Take practice exams
5. Schedule AWS certification exam
6. Continue with advanced AWS certifications
